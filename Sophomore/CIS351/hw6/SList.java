...
//    }
  ...
  public SList<T> reverseCopy() {
    ...
    for(int i = n-1; i >= 0; i--){ //reverse the list by starting from the last element and moving backwards instead of vice versa.
      ans.add(this.get(i));
    }
    return ans;
  }
  ...
  public void reverse() {
    ...
    temp = this.reverseCopy(); //use reverseCopy to create a new reversed list.
    this.clear();
    this.addAll(temp);
  }
