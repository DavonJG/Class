...
//    
    ...
    System.out.println(ts1.timesAbove(9,0,99));
    System.out.println(ts1.timesAbove(9,0,96));
    ...
    // (Use try/catch blocks.) 
    System.out.println(ts2.oscillation(0,90));
    System.out.println(ts2.oscillation(0,99));
    ...
    // Add two tests that oscillation throws its exceptions correctly 
    // (Use try/catch blocks.)
    System.out.println(ts2.runningAvg(97));
    System.out.println(ts2.runningAvg(82));
  }
}