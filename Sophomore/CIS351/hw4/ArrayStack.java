...
public class ArrayStack {
  ...
  public boolean delete(int e) {
    for(int i=0; i<this.size(); i++){ //loop through the entire ArrayStack
      if(e == this.get(i)){ //if the value is found going from left to right, delete it and break the loop by returning true
        this.remove(i);
        return true;
      }
    }
